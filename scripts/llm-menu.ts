 ...
 * to generate menu JSON from raw text. This is a stub to be implemented
 * by future agents.
 */

/**
 * Call LLM to generate menu JSON from raw text
 * 
 * @param rawText - Raw menu text to process
