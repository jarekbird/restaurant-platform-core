# TASK-029: Create ingestion directories
...
Create ingestion directories. This task involves: Create `ingestion/input/` and `ingestion/output/` directories (can be empty in git with `.gitkeep`). This task is part of Phase 5: AI Menu Ingestion Tooling and contributes to building the restaurant platform core application.
...
- [ ] Step 1: Create `ingestion/input/` and `ingestion/output/` directories (can be empty in git with `.gitkeep`).
