# TASK-038: Implement second restaurant demo data
...
Implement second restaurant demo data. This task involves: Create `data/restaurants/<second-slug>/config.json` and `menu.json` with a different cuisine and theme.; Add or tweak theme tokens (e.g., `"cafe-warm"`). This task is part of Phase 7: Demo Restaurant Implementations and contributes to building the restaurant platform core application.

**Reference Implementation**: `plan/phase-1/master-plan.md`

## Current State

- Previous tasks: [T-021], [T-022], [T-050]
...
**Important**: This task depends on: [T-021], [T-022], [T-050]
...
- [ ] Understand dependencies and prerequisites: [T-021], [T-022], [T-050]
...
- [ ] Step 1: Create `data/restaurants/<second-slug>/config.json` and `menu.json` with a different cuisine and theme.
- [ ] Step 2: Add or tweak theme tokens (e.g., `"cafe-warm"`).
...
- **Execution Timing**: Execute after completing dependencies: [T-021], [T-022], [T-050]
- **Dependencies**: [T-021], [T-022], [T-050]
