# TASK-033: Add placeholder data files in template site
...
Add placeholder data files in template site. This task involves: Add `templates/site/data/menu.json` and `templates/site/data/config.json` with simple placeholder content and TODO comments. This task is part of Phase 6: Restaurant Scaffolding and contributes to building the restaurant platform core application.

**Reference Implementation**: `plan/phase-1/master-plan.md`

## Current State

- Previous tasks: [T-070]
...
**Important**: This task depends on: [T-070]
...
- [ ] Understand dependencies and prerequisites: [T-070]
...
- [ ] Step 1: Add `templates/site/data/menu.json` and `templates/site/data/config.json` with simple placeholder content and TODO comments.
...
- **Execution Timing**: Execute after completing dependencies: [T-070]
- **Dependencies**: [T-070]
