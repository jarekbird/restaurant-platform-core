# TASK-2-2-5: Define shared chat types
...
- [ ] Step 1: Add a small types module (e.g., `lib/ai/types.ts`) defining `ChatMessage`, `ChatRole`, and `ChatAction`.
- [ ] Step 2: Ensure types align with how `chatService` and `actionParser` will be implemented.
