# TASK-2-2-14: Implement chat-driven add-to-cart flow
...
- [ ] Step 1: Ensure phrases like "Add two California Rolls" result in correct cart updates via `ADD_ITEM` and `UPDATE_QUANTITY`.
- [ ] Step 2: Update chat history with a confirmation and a brief cart summary.
