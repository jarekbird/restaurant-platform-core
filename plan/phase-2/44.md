# TASK-2-4-3: Implement unit tests for AI helpers
...
- [ ] Step 1: Add tests for `buildSystemPrompt` to ensure it encodes menu and cart context correctly.
- [ ] Step 2: Add tests for `actionParser` to verify it maps representative AI responses to correct `ChatAction` structures.
- [ ] Step 3: Add tests for menu lookup helpers (e.g., fuzzy matching behavior).
