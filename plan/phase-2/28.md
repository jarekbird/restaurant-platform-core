# TASK-2-2-11: Implement client-side chat service wrapper
...
- [ ] Step 1: Create a small client-side helper (e.g., `lib/ai/chatClient.ts`) that posts to `/api/chat`.
- [ ] Step 2: Handle loading state, basic retries, and mapping of response shape to frontend types.
