# TASK-2-1-17: Verify full cart flow manually
...
- [ ] Step 1: From `/preview/[slug]`, add items, open cart, adjust quantities, remove items, and complete checkout.
- [ ] Step 2: Confirm totals, counts, and clearing behavior all work end-to-end.
