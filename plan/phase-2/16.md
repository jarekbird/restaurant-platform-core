# TASK-2-1-16: Replace `alert` with `OrderConfirmationModal`
...
- [ ] Step 1: Refactor `handleCheckout` to set state to show `OrderConfirmationModal` instead of calling `alert`.
- [ ] Step 2: Pass the order summary into the modal.
- [ ] Step 3: Ensure closing the modal clears the cart and closes the drawer.
