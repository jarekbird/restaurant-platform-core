# TASK-2-1-15: Create `OrderConfirmationModal` component
...
- [ ] Step 1: Add `components/order/OrderConfirmationModal.tsx` with a basic modal.
- [ ] Step 2: Accept props for order summary (items, total, customer name) and `onClose`.
- [ ] Step 3: Ensure keyboard and screen-reader-friendly semantics (focus trap, `role="dialog"`, ARIA labels).
