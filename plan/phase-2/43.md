# TASK-2-4-2: Implement unit tests for cart UI components
...
- [ ] Step 1: Test `CartDrawer` rendering of items, totals, and remove/quantity controls.
- [ ] Step 2: Test `OrderButton` badge behavior and click handling.
- [ ] Step 3: Test `OrderConfirmationModal` visibility and dismissal behavior.
