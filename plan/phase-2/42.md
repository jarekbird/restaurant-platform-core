# TASK-2-4-1: Implement unit tests for cart logic
...
- [ ] Step 1: Add tests for `useCart` to cover add, remove, update quantity, clear, and total/itemCount calculation.
- [ ] Step 2: Add tests for `CartProvider` to ensure context provides correct values and throws outside provider.
