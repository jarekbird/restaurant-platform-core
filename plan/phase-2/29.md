# TASK-2-2-12: Integrate AI call into `ChatAssistant`
...
- [ ] Step 1: On `onSend` in `ChatAssistant`, call the client chat helper with:
- [ ] Step 2: Current conversation history.
- [ ] Step 3: Current menu (or a menu identifier the server can use).
- [ ] Step 4: Current cart snapshot from `useCartContext`.
- [ ] Step 5: Append an assistant "typing…" placeholder while waiting, then replace it with the real AI message.
