# TASK-2-2-3: Implement chat input component
...
- [ ] Step 1: Create `components/chat/ChatInput.tsx` with a text input and send button.
- [ ] Step 2: Support `Enter` to submit and disabled state while a message is in-flight.
- [ ] Step 3: Expose an `onSend(message: string)` callback.
