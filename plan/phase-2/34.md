# TASK-2-2-17: Add example conversation starter buttons
...
- [ ] Step 1: In `ChatAssistant`, render buttons such as "What can I get?", "Order a miso soup", "Add two California Rolls", and "Checkout".
- [ ] Step 2: On click, pre-fill or send these messages through the same flow as typed input.
