# TASK-2-3-1: Implement toast notification system
...
- [ ] Step 1: Introduce a simple toast solution (third-party or custom) at the app root or layout level.
- [ ] Step 2: Expose a hook (e.g., `useToast`) to trigger messages from cart and chat components.
