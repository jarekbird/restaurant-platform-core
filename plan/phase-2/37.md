# TASK-2-3-2: Add toasts for cart and chat events
...
- [ ] Step 1: Show "Item added to cart" when `addItem` is called (from button or chat).
- [ ] Step 2: Show "Item removed from cart" when `removeItem` is called.
- [ ] Step 3: Show "Order placed successfully" after checkout completes.
- [ ] Step 4: Optionally show brief notifications for important chatbot events or errors.
