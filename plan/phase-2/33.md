# TASK-2-2-16: Implement chat-driven checkout flow
...
- [ ] Step 1: Map a `CHECKOUT` action from chat to opening the existing cart drawer and/or checkout form.
- [ ] Step 2: Have the assistant message explain that the checkout form is now open.
- [ ] Step 3: Confirm order completion in chat after the user submits the checkout form.
