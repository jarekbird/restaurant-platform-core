# TASK-2-3-3: Implement cart persistence (optional)
...
- [ ] Step 1: Persist cart state to `localStorage` (or similar) in `useCart`.
- [ ] Step 2: Restore persisted cart on app load.
- [ ] Step 3: Ensure hydration logic avoids mismatches between server and client.
