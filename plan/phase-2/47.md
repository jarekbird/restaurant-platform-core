# TASK-2-4-6: Update architecture documentation
...
- [ ] Step 1: In `docs/architecture.md`, document:
- [ ] Step 2: Cart system architecture (including add/remove/update operations and persistence).
- [ ] Step 3: AI chat system architecture and LLM integration approach.
- [ ] Step 4: Action extraction and integration points between chat and cart.
- [ ] Step 5: State management overview and API key handling.
