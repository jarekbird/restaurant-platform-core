# TASK-2-2-10: Add menu lookup helpers for chat
...
- [ ] Step 1: Implement helper functions (e.g., `findMenuItemByName(menu, name)`) for fuzzy/exact matching.
- [ ] Step 2: Ensure helpers consider categories, item names, and synonyms where possible.
