# TASK-2-2-2: Implement chat message display component
...
- [ ] Step 1: Create `components/chat/ChatMessage.tsx` to render a single message.
- [ ] Step 2: Support styling differences for user vs. assistant messages.
- [ ] Step 3: Optionally include timestamps and a simple typing indicator hook-in.
