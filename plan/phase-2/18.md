# TASK-2-2-1: Scaffold chat UI container (`ChatAssistant`)
...
- [ ] Step 1: Create `components/chat/ChatAssistant.tsx` as a client component.
- [ ] Step 2: Add layout for a collapsible sidebar (desktop) or bottom drawer (mobile).
- [ ] Step 3: Implement toggle button to open/close the chat panel.
